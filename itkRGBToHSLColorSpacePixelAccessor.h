/*=========================================================================
  ...
  Module:    $RCSfile: itkRGBToHSLColorSpacePixelAccessor.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkRGBToHSLColorSpacePixelAccessor_h
#define __itkRGBToHSLColorSpacePixelAccessor_h
...
{
/**
 * \class RGBToHSLColorSpacePixelAccessor
...
class ITK_EXPORT RGBToHSLColorSpacePixelAccessor
{
public:
  /** Standard class typedefs. */
  typedef   RGBToHSLColorSpacePixelAccessor        Self;
 ...
 /** External typedef. It defines the external aspect
  ...
  /** Write access to the RGBToHSLColorSpace component */
  inline void Set( InternalType & output, const ExternalType & input ) const
    ...
    output[2] = static_cast<TInput>(L); // L
    
    return output;
    }

  /** Read access to the RGBToHSLColorSpace component */
  inline ExternalType Get( const InternalType & input ) const
    ...
    output[2] = static_cast<TOutput>(L); // L
